...
**QQ-plot**
* The QQ-plot helps determine whether residuals are normally distributed an important assumption of regression. 
...
<span style="color: blue;"> 
The cubic model suggests that time spent modeled using a cubic function does not significantly predict cognitive load. 
</span>
...
<span style="color: blue;"> 
The quadratic model suggests that time spent modeled using a quadratic function, or to the second degree term,  significantly predicts cognitive load.
</span>
